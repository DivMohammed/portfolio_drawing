...
let animation=()=>{
  ...
  homeTl.from('.hold_home_text h1',{x:'-200px', opacity:0,duration:1} )
        .from('.hold_home_text p',{x:'-200px', opacity:0,duration:1}, '<0.3' )
        .from('.hold_home_text button',{x:'-200px', opacity:0,duration:1}, '<0.3' )
...
//run the animation only when everything is loaded to prevent weird behavior
